...
# needed because of this: https://stackoverflow.com/questions/36279253/go-compiled-binary-wont-run-in-an-alpine-docker-container-on-ubuntu-host
ENV CGO_ENABLED=0
...
RUN go get github.com/nyaruka/phonenumbers && go get github.com/gorilla/mux
...
RUN go build -o phonenumber-microservice-go

# Let's create a /dist folder containing just the files necessary for runtime.
# Later, it will be copied as the / (root) of the output image.
#WORKDIR /app
#RUN cp phonenumber-microservice-go ./phonenumber-microservice-go
...
CMD ["/app/phonenumber-microservice-go"]